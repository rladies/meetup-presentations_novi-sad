...
<span style="color:#a1007a"> Import TEXT DATA 
...
Ime planete: Merkur, Venera, Zemlja, Mars, Jupiter, Saturn, Uran, Neptun

Tip planete : Terra (Terrestrial - kamen) : Merkur, Venera, Zemlja, Mars,  i Gas (Gas Giant - gasovita ) : Jupiter, Saturn, Uran, Neptun

Precnik : Merkur( 0.382), Venera (0.949), Zemlja ( 1), Mars ( 0.532), Jupiter ( 11.209), Saturn ( 9.449), Uran ( 4.007), Neptun ( 3.883)

Rotacija : Merkur( 58.64), Venera ( -243.02), Zemlja ( 1), Mars ( 1.03), Jupiter ( 0.41), Saturn ( 0.43), Uran ( -0.72), Neptun ( 0.67) 

Prsten - da li planeta ima prsten  ili ne: IMA PRSTEN : Jupiter, Saturn, Uran, Neptun,  ostale nemaju prsten 
</span>
