...
#  <span style="color:aliceblue"> ** Lean2Shiny ** </span> 
...
#  <span style="color:aliceblue"> ** Kako početi? ** </span> 


### 1. Otvori R Studio 
### 2. Instaliraj paket <span style="color:aquamarine">  **Shiny**  </span>  

<span style="color:antiquewhite"> Sećaš se? Imaš dve opcije: </span> 
...
- <span style="color:aquamarine"> Packages -> Install </span> u desnom donjem delu R Studio-a
